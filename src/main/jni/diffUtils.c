//
// Created by genius-ye on 2017/4/26.
//
...
#include "com_genius_smartappupdateslib_DiffUtils.h"
...
JNIEXPORT jint JNICALL Java_com_genius_smartappupdateslib_DiffUtils_genDiff(JNIEnv *env,
